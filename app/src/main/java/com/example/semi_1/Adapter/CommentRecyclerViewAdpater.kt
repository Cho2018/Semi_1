...
import com.example.semi_1.Data.CommentData
import com.example.semi_1.R

class CommentRecyclerViewAdpater(val ctx: Context, val dataList: ArrayList<CommentData>): RecyclerView.Adapter<CommentRecyclerViewAdpater.Holder>() {
